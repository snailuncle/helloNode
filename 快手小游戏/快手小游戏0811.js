...
function whichPage(){
  ...
  log("gameNameCount=",gameNameCount)
   gameNameList=["消砖块","连连看","吃鸡游戏","高尔夫","跳一跳","斗兽棋","你画我猜","拯救萌宠","六角拼拼","宠物足球","摩天汉堡","蚂蚁夫妇","谁是卧底","象棋","方块消除","过马路","飞猪小奇","火力全开","大圣来了","心动魔方","圈圈消除","娃娃机","跳冰箱","两点之间","翻转棋","一起跳舞","互怼小霸王","吹泡泡","动物塔","双人拼图","蛋糕塔","五子棋","2048","手势告白","数来钱","容嬷嬷来了","奔向傻白甜","表情大战","男左女右","火锅侠","咆哮二驴","女神来了","跳舞机","扫雷","翻翻乐"]
